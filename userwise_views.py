    ...
    if request.method == 'POST':
        try:
            ...
            for row in raw_data_values:
                ...
                if scope == 'DA1':
                    fromfun = userwisequalityreportDA1(row,fromdate,todate,language_sl,filename,location,scope)
                    ...
                    fromfun1 = userwisequalityreportDA1(row,fromdate,todate,language_sl,filename,location,scope)
                
                    frontendlist.extend(fromfun1)
                    
                    fromfun2 = userwisequalityreportDA2(row,fromdate,todate,language_sl,filename,location,scope)
                
                    frontendlist.extend(fromfun2)


             
            # for user in raw_data_values:

            #     fromfun = userwisequalityreport(user,fromdate,todate,language_sl,filename,location,scope)
...
#######################################################################################################################################################################################
                    ...
                    return render(request, 'pages/QualityReport.html', {'locations': locations, 'filenames': filenames,'language':language_list,'response_data_list':frontendlist})
...
def userwisequalityreportDA1(userid,fromdate,todate,language_sl,filename,location,scope):

            print(userid,language_sl)
            return []

def userwisequalityreportDA2(userid,fromdate,todate,language_sl,filename,location,scope):
